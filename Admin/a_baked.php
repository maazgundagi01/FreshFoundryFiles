    ...
    <main>
            ...
            <div class="accordion accordion-flush">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingOne">
                        <h2 class="accordion-button collapsed" style="cursor: pointer; margin: 0%;"
                            data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false"
                            aria-controls="flush-collapseOne">
                            Inventory
                        </h2>
                    </h2>
                    <div id="flush-collapseOne" class="accordion-collapse collapse custom-sidebar"
        ...
        <div class="adminops">
            ...
            <form action="goods_execute.php" method="POST" enctype="multipart/form-data">
                <h1 class="formHead">Add Products - Baked Goods</h1>
                <!--Name Input-->
                <div class="row">
                    <div class="mb-3 col">
                        <label for="nameField" class="form-label opsFormIp1">Name</label>
                        <input type="text" name="goods_name" class="form-control" id="nameInput"
                            placeholder="Example input placeholder">
                    </div>
                    <!--Price-->
                    <div class=" col">
                        <label for="priceField" class="form-label opsFormIp1">Price</label>
                        <input type="text" name="price" class="form-control" id="nameInput"
                            placeholder="Example input placeholder">
                    </div>
                    <!--Goods Id -->
                    <div class="row">
                        <div class=" col">
                            ...
                            <input type="text" name="goods_id" class="form-control" id="nameInput"
                                placeholder="Example input placeholder">
                        </div>
                        <!--Image Input-->
                        <div class=" col ">
                        ...
                        <!--Product-->
                        <input type="hidden" name="prod_name" id="" value="baked goods" />
                        <div><button type="submit" class="submit"
                                style="border-radius:10px; border:none; box-shadow: 2px 2px 5px rgba(0,0,0,0.3); padding: 0.5em 1em;">Add
                                product</button>
                            <div>
                            </div>
            </form>
