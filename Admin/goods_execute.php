...
if($prod_id === 'ff-fp-01'){
    $query = "INSERT INTO fresh_produce VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
...
if($prod_id === 'ff-ff-02'){
    $query = "INSERT INTO frozen_foods VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
...
if($prod_id === 'ff-xm-03'){
    $query = "INSERT INTO meat VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
...
if($prod_id === 'ff-xd-04'){
    $query = "INSERT INTO dairy VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
...
if($prod_id === 'ff-xs-05'){
    $query = "INSERT INTO spices VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
...
if($prod_id === 'ff-bg-06'){
    $query = "INSERT INTO baked_goods VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
...
if($prod_id === 'ff-xb-07'){
    $query = "INSERT INTO beverages VALUES ('','$goods','$g_id','$prod_id','$price','$image')";
    $stmt = $db->prepare($query);
    $stmt->execute();
    $stmt->closeCursor();
}
