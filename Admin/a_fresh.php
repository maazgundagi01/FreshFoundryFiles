    ...
    <main>
        ...
        <div class="adminops">
            ...
            <form action="goods_execute.php" method="POST" enctype="multipart/form-data">
                ...
                <!--Product-->
                <input  type="hidden" name="prod_name" id="" value="fresh produce"/>
