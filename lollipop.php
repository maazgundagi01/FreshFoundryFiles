            ...
            <div class="accordion accordion-flush">
                <div class="accordion-item">
                  ...
                  <div id="flush-collapseOne" class="accordion-collapse collapse custom-sidebar" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    ...
                    <h2 class="dashitem">
                        <a style="text-decoration: none;color: black;" href="./admin/allorders.php">Orders</a>
                    </h2>
                    <!--Dashboard ITEM 3 - Users -->
                    <h2 class="dashitem">
                        <a style="text-decoration: none;color: black;" href="./admin/users.php">Users</a>
                    </h2>
                    <!--Dashboard ITEM 4 - Queries -->
                    <h2 class="dashitem">
                        <a style="text-decoration: none;color: black;" href="./admin/cxqueries.php">Queries</a>
                    </h2>
